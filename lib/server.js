...
var PAGE_DONE_CHECK_TIMEOUT = process.env.PAGE_DONE_CHECK_TIMEOUT || 2000;

var RESOURCE_DOWNLOAD_TIMEOUT = process.env.RESOURCE_DOWNLOAD_TIMEOUT || 20 * 1000;

var WAIT_AFTER_LAST_REQUEST = process.env.WAIT_AFTER_LAST_REQUEST || 2000;

var JS_CHECK_TIMEOUT = process.env.JS_CHECK_TIMEOUT || 500;

var JS_TIMEOUT = process.env.JS_TIMEOUT || 20 * 1000;

var EVALUATE_JAVASCRIPT_CHECK_TIMEOUT = process.env.EVALUATE_JAVASCRIPT_CHECK_TIMEOUT || 500;
...
server.createPhantom = function() {
    ...
    var arguments = ["--load-images=false", "--ignore-ssl-errors=true", "--ssl-protocol=tlsv1"];

    if(this.options.phantomArguments) {
        arguments = this.options.phantomArguments;
    }
    ...
    arguments.push(_.bind(this.onPhantomCreate, this));

    phantom.create.apply(this, arguments);
};
